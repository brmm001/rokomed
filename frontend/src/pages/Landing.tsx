  ...
  return (
    <>
      <style>{`
        ...
        .lp-mq-inner span { font-family:var(--mono); font-size:.7rem; letter-spacing:.12em; text-transform:uppercase; color:rgba(243,237,226,.6); padding:0 2rem; }
        .lp-mq-inner .lp-dot { color:#BC2A1A; opacity:1; font-size:1rem; padding:0 .5rem; }
        ...
        .lp-pc.lp-feat .lp-pc-lbl { color:rgba(243,237,226,.45); }
        ...
        .lp-pc.lp-feat .lp-pc-price .lp-cur { color:rgba(243,237,226,.45); }
        ...
        .lp-pc.lp-feat .lp-pc-price .lp-per { color:rgba(243,237,226,.45); }
        hr.lp-r { border:none; border-top:1px solid var(--rule); }
        .lp-pc.lp-feat hr.lp-r { border-color:rgba(243,237,226,.15); }
